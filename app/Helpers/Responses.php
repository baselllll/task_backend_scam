...
if (!function_exists('bad_request')) {
    ...
    {
        $message = $message ? $message : __('something_went_wrong');
...
if (!function_exists('unauthenticated')) {
    ...
    {
        $message = $message ?: __('you_must_login');
...
if (!function_exists('forbidden')) {
    ...
    {
        $message = $message ?: __('access_denied');
...
if (!function_exists('not_found')) {
    ...
    {
        $message = $message ?: __('resource_not_found');
...
if (!function_exists('unprocessable_entity')) {
    ...
    {
        $message = $message ? $message : __('invalid_inputs');
